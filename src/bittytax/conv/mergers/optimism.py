...
DataMerge("Optimistic etherscan fees & multi-token transactions",
          {TXNS: {'req': DataMerge.MAN, 'obj': OPTIMISM_TXNS},
           TOKENS: {'req': DataMerge.OPT, 'obj': OPTIMISM_TOKENS},
           NFTS: {'req': DataMerge.OPT, 'obj': OPTIMISM_NFTS},
           INTERNAL_TXNS: {'req': DataMerge.OPT, 'obj': OPTIMISM_INT},
           DEPOSITS: {'req': DataMerge.OPT, 'obj': OPTIMISM_DEPOSITS},
           WITHDRAWALS: {'req': DataMerge.OPT, 'obj': OPTIMISM_WITHDRAWALS}},
          merge_optimism)
